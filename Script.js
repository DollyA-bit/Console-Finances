...
console.log(totalMonths(finances)); // Output: 84
...
// probably a loop
function netProfitLoss(finances) {
  let total = 0;
...
console.log(netProfitLoss(finances));
...
let maxProfitIncrease = 0;
let maxProfitMonth = '';

for (let i = 1; i < finances.length; i++) {
  let profitIncrease = finances[i][1] - finances[i - 1][1];
...
console.log(`The greatest increase in profits was ${maxProfitIncrease} in ${maxProfitMonth}.`);
